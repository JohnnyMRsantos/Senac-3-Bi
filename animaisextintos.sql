...
--
-- Índices de tabela `animaisextintos`
--
ALTER TABLE `animaisextintos`
  ADD PRIMARY KEY (`id__animaisextintos`);
...
--
-- AUTO_INCREMENT de tabela `animaisextintos`
--
ALTER TABLE `animaisextintos`
  MODIFY `id__animaisextintos` int(255) NOT NULL AUTO_INCREMENT;
COMMIT;
