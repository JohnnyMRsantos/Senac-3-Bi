...
--
-- Índices de tabela `característicasdosanimais`
--
ALTER TABLE `característicasdosanimais`
  ADD PRIMARY KEY (`id_caracteristicasdosanimais`);
...
--
-- AUTO_INCREMENT de tabela `característicasdosanimais`
--
ALTER TABLE `característicasdosanimais`
  MODIFY `id_caracteristicasdosanimais` int(255) NOT NULL AUTO_INCREMENT;
COMMIT;
